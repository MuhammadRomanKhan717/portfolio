    ...
    <div className="text-lg text-center relative isolate px-6 py-24 lg:px-8">
      <div className="mt-10 flex items-center justify-center gap-x-4">
        ...
        <button
          ...
          onClick={() =>
            window.open("https://www.fiverr.com/muhammadromankh", "_blank")
          }
        >
        ...
        <a
          href="mailto:romankhan03346869717@gmail.com"
          target="_blank"
          rel="noopener noreferrer"
      ...
      <p className="mt-3">
        Created with ❤️ by <span className="font-bold">M.R.Khan</span>
      </p>
